        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Features_Statuses_CurrentStatusId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProjectId = table.Column<int>(type: "int", nullable: false),
                    RoleId = table.Column<int>(type: "int", nullable: false),
                    JoinReason = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProjectJoinRequests_Roles_RoleId",
                        column: x => x.RoleId,
                        principalSchema: "identity",
                        principalTable: "Roles",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProjectResources_Users_CreatedByUserId",
                        column: x => x.CreatedByUserId,
                        principalSchema: "identity",
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProjectResources_Users_UpdatedByUserId",
                        column: x => x.UpdatedByUserId,
                        principalSchema: "identity",
                        principalTable: "Users",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ProjectResources_Users_UserId",
                        column: x => x.UserId,
                        principalSchema: "identity",
                        principalTable: "Users",
                        principalColumn: "Id",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "a1b2c3d4-0001-0000-0000-000000000001", "Project Manager", "PROJECT MANAGER" },
                    { 2, "a1b2c3d4-0002-0000-0000-000000000002", "Business Analyst", "BUSINESS ANALYST" },
                    { 3, "a1b2c3d4-0003-0000-0000-000000000003", "System Analyst", "SYSTEM ANALYST" },
                    { 4, "a1b2c3d4-0004-0000-0000-000000000004", "UI/UX Designer", "UI/UX DESIGNER" },
                    { 5, "a1b2c3d4-0005-0000-0000-000000000005", "Developer", "DEVELOPER" },
                    { 6, "a1b2c3d4-0006-0000-0000-000000000006", "Quality Assurance", "QUALITY ASSURANCE" }
                });

            migrationBuilder.InsertData(
                table: "Stages",
                columns: new[] { "Id", "Sequence", "StageName" },
                values: new object[,]
                {
                    { 1, 10, "Project Planning" },
                    { 2, 20, "Requirements Analysis" },
                    { 3, 30, "System Architecture" },
                    { 4, 40, "UI/UX Design" },
                    { 5, 50, "Development" },
                    { 6, 60, "Quality Assurance" },
                    { 7, 70, "Deployment" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Features_CurrentStatusId",
                table: "Features",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectJoinRequests_RoleId",
                table: "ProjectJoinRequests",
                column: "RoleId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectResources_CreatedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectResources_UpdatedByUserId",
                table: "ProjectResources",
                column: "UpdatedByUserId");
